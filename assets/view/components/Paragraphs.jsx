...
function Paragraphs() {
    ...
    const handleSend = () => {
        ...
        api.get(`/lorem/paragraphs?count=${count}&nb=${nb}`).then((result) => {
            setData(result.data);
        });
    };
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Grid size={12}>
                <TextField type="number" fullWidth={true} onChange={event => setNb(Number(event.target.value))} value={nb} label="Nb" variant="outlined" placeholder="1" />
            </Grid>
            <Grid size={12}>
